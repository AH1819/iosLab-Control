...
public class PanelAction extends javax.swing.JPanel {
    ...
    public void initEvent(TableActionEvent event, int row) {
        ...
        Nota.addActionListener((ActionEvent ae) -> {
            event.onComment(row);
        });
    }
    ...
    private void initComponents() {
        ...
        Nota = new Model.Views.ActionButton();
        ...
        Nota.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Icons/notas.png"))); // NOI18N
        Nota.setToolTipText("Agregar nota");
    ...
    public Model.Views.ActionButton Nota;
